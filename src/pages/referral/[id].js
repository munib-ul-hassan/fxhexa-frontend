import { referralSchema } from "@/components/Schema/DepositSchema";
  ...
  return (
    <div className="min-h-screen p-5 bg-white dark:bg-gray-800 ">
      <h6 className="text-2xl font-bold my-6 text-gray-500 dark:text-gray-300">
        Create Referral Withdraw Request
      </h6>
      <div className="w-6/12">
        ...
        <Formik
          ...
          validationSchema={referralSchema(router.query.amount)}
          onSubmit={(values) => {
            ...
            axios
              .post(
                `${Environment.BASE_URL}user/request`,
                { ...allValues },
                config
              )
              .then((res) => {
